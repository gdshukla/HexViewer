...
void CHexViewerDlg::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Text(pDX, IDC_STATIC_FILE_SIZE, m_FileSize);
}
...
BOOL CHexViewerDlg::OnInitDialog()
{
    ...
    myFont->CreateFont(14, 0, 0, 0, FW_NORMAL, false, false,
        0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY,
        FIXED_PITCH | FF_MODERN, _T("Consolas"));
    GetDlgItem(IDC_EDIT_HEX)->SetFont(myFont);
    GetDlgItem(IDC_STATIC_HEADER)->SetFont(myFont);
...
void CHexViewerDlg::OnEnChangeMfcFileName()
{
    ...
    m_Hex = createHexBuffer(fdata.data, fdata.size);
//    m_text = cs;
    UpdateData(false);
