...
// HexViewer.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CHexViewerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CHexViewerApp construction

CHexViewerApp::CHexViewerApp()
{
...
BOOL CHexViewerApp::InitInstance()
{
